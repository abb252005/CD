...
#--------------------------------------------------
        ...
        # # t1: Draw a vertical-ish line
        # if now < 1.0: 
        #     p1.publish(get_twist(0, 2.0)) # Rotate at 1.57 rad/s for 1 sec
        # # Phase 2: Move Straight (which is now Vertical)
        # elif now < 3.0:
        #     p1.publish(get_twist(1.5, 0)) 
        # else:
        #     p1.publish(get_twist(0, 0))
#--------------------------------------------------
        # t3: Draw 3 (Two arcs)
